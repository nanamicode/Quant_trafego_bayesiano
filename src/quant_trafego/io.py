...
ALIASES = {
    ...
    "campaign_name": ["campaign_name", "nome_da_campanha", "nome campanha", "nome da campanha", "campaign name"],
    ...
    "status": ["status", "delivery", "veiculacao", "veiculação", "veiculação de anúncio", "veiculacao de anuncio", "veiculação do anúncio", "veiculacao do anuncio", "veiculação do conjunto de anúncios", "veiculacao do conjunto de anuncios", "veiculação da campanha", "veiculacao da campanha"],
