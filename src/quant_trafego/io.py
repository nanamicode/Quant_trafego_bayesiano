...
ALIASES = {
    ...
    "adset_daily_budget": ["adset_daily_budget", "ad set budget", "adset budget", "daily ad set budget", "orcamento_diario_do_conjunto", "orçamento diário do conjunto", "orcamento_do_conjunto", "orçamento do conjunto"],
    ...
    "checkouts": ["checkouts", "initiate_checkout", "checkouts_iniciados", "inicios_de_finalizacao", "inícios de finalização"],
